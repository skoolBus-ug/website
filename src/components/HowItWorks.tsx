...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-24 relative overflow-hidden" style={{ background: "linear-gradient(150deg, #0f172a 0%, #1e3a8a 45%, #1d4ed8 100%)" }}>
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-10">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-white leading-tight mb-4">
              Up &amp; running in <span className="bg-yellow-400 text-gray-900 px-2 rounded-lg">one day</span>
            </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          ...
          <div className="hidden lg:block absolute top-13.5 left-[17%] right-[17%] h-1 z-0 rounded-full" style={{ background: "linear-gradient(90deg, #f97316, #3b82f6, #8b5cf6, #10b981)" }} />
            ...
            <ScrollReveal key={s.num} delay={i * 150}>
              <div className="relative z-10 flex flex-col items-center text-center group">
                ...
                <div className={`relative w-28 h-28 bg-linear-to-br ${s.grad} rounded-3xl flex items-center justify-center shadow-2xl ring-8 ${s.ring} mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}>
                  ...
                  {/* Step number badge */}
                  <div className="absolute -top-3 -right-3 w-9 h-9 bg-white border-4 border-gray-100 text-gray-800 text-sm font-black rounded-full flex items-center justify-center shadow-lg">
                    {s.num}
                  </div>
                </div>
                ...
                <div className="relative bg-white/8 border border-white/10 rounded-2xl p-5 w-full overflow-hidden">
                  ...
                  <p className="text-blue-100/70 text-sm leading-relaxed font-semibold relative">{s.desc}</p>
                </div>
              </div>
            </ScrollReveal>
          ))}
          ...
          <div className="mt-14 flex justify-center">
            <div className="bg-white/8 border border-white/10 rounded-3xl px-8 py-6 flex flex-col sm:flex-row items-center gap-5 max-w-xl w-full">
              <div className="text-center sm:text-left">
                ...
                <p className="text-blue-100/70 text-sm font-semibold">Our team sets everything up for you — for free!</p>
              </div>
              <a href="#contact" className="btn-fun bg-yellow-400 hover:bg-yellow-300 text-yellow-900 font-black px-8 py-4 rounded-full shrink-0 sm:ml-auto">
                Get Started
              </a>
            </div>
          </div>
