      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-10">
        ...
        <ScrollReveal>
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-gray-900 leading-tight mb-4">
              Everything your school <span className="bg-yellow-400 text-gray-900 px-2 rounded-lg">needs</span> in one place
            </h2>
            ...
            <ScrollReveal key={group.category} delay={i * 100}>
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="font-black text-gray-900 text-sm leading-none">{group.category}</p>
                    <p className="text-gray-400 text-xs font-semibold mt-0.5">{group.tagline}</p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-1.5 mb-4">
                  {group.modules.map((mod) => (
                    <Link
                      ...
                      className="inline-flex items-center gap-1.5 bg-white border border-gray-100 text-gray-700 font-semibold text-xs px-3 py-1.5 rounded-full hover:border-gray-300 hover:shadow-sm transition-all"
                    >
                      <FlatIcon name={mod.icon} size={11} className="text-gray-400 shrink-0" />
                      {mod.title}
                    </Link>
                  ))}
                </div>
        ...
        <ScrollReveal delay={200}>
          <div className="mt-10 text-center">
            <Link
              href="/modules"
              className="btn-fun inline-flex items-center gap-2 bg-gray-900 hover:bg-gray-800 text-white font-black px-8 py-4 rounded-full text-base mr-3"
            >
              Explore all modules →
            </Link>
            <Link
              href="#contact"
              className="btn-fun inline-flex items-center gap-2 bg-yellow-400 hover:bg-yellow-300 text-yellow-900 font-black px-8 py-4 rounded-full text-base"
            >
              Start free today
            </Link>
            <p className="text-gray-400 text-sm font-semibold mt-3">No credit card required · Setup in 24 hours</p>
          </div>
        </ScrollReveal>
      </div>
    </section>
